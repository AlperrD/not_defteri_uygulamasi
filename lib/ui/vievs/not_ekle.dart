...
void _formatDateTime() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:  Text(appBarTitleText,style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              context.read<NotEkleCubit>().kaydet(baslikController.text,notController.text,formattedDateTime), ScaffoldMessenger.of(context).showSnackBar( SnackBar(content: Text(notEklemeBasarili))),
              setState(() {
                notController.text = "";
